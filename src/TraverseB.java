public class TraverseB {


//    Doubling the value
//        Basic Accuracy: 71.53% Submissions: 6541 Points: 1
//
...
//        hence B becomes 16.
//
//        Example 1:       Input:    N = 5, B = 3, arr[] = {1 2 3 4 8};  Output: 6
...
//        1<=arr[i]<=1018
    ...
    public static int getBDoubleValue(int[] arr, int b) {
    ...
    public static void main(String[] args) {
        int arr[] = {1, 2, 3, 4, 8};
        int b = 2;
        System.out.println(TraverseB.getBDoubleValue(arr, b));
    }
